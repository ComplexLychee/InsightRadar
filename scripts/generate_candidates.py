...
def search_papers():
    ...
    if preset == "sdc_reliability":
        use_filter = True
        filter_keywords = SDC_KEYWORDS
        print(f"🔍 客户端过滤: SDC 严格模式")
    elif preset in ("research_agents", "weekly_auto"):
        use_filter = True
        filter_keywords = SDC_KEYWORDS + AGENTS_KEYWORDS
...
def main():
    print("=" * 60)
    print("🚀 Insight Radar · 候选池生成器（双专栏自动检索版）")
    print("=" * 60)
